...
<body>
 ...
 <!-- 当前位置 -->
 <div id="location">
  <div class="wrapper margin">您的目前页面：<a href="#">首页</a> > <a href="#">消息详情</a> </div>
 </div>
    ...
    <!-- / 当前位置 / -->
     ...
     <div class="mt">
      ...
      <div class="button_box">
	       <a href="/Team3_ZXJY/jspf/MessageList.jsp"><input class="submit" type="button" name="button" id="button" value="返回列表" /></a>&nbsp;&nbsp;&nbsp;
