...
<script type="text/javascript" src="lib/jstl-1.2.jar"></script>
</head>
...
<body>
 ...
 <div class="location clear f12">您的目前页面：<a >后台管理首页</a> > <a href="#">添加</a>学生</div>
    ...
    <div class="informationcx f14">
     <div class="title f16">
      <div class="titletext">修改学生信息</div>
     </div>
      <form action="/Team3_ZXJY/studentUpdate" method="post" >
     <div class="mt">
    
       <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
        <tr>
          <td width="130" align="right" valign="middle">学生姓名：</td>
          <td><input class="text01" type="text" name="stuName" id="textfield" value="${stu.stuName}"  />&nbsp;</td>
        </tr>
        <tr>
          <td width="130" align="right" valign="middle">学生学号：</td>
          <td><input class="text01" disabled="disabled" type="text" name="stuNo" id="textfield" value="${stu.stuno}" />&nbsp;</td>
        </tr>
     	  <tr>
       ...
       <td> <textarea class='text01' name="detail" width="130" align="right" cols="40" rows="5" style='height: 50px' >
       ${stu.detail}
        </textarea></td>
        </tr>
      </table>
