...
<body>
 ...
 <div id="incontainer" class="clear mb01">
  ...
  <div id="mainContent">
   ...
   <div id="content">
    <!-- / 当前位置 / -->
 <div class="location clear f12">您的目前页面：<a >后台管理首页</a> > <a >公告列表</a> > <a >公告详情</a></div>
    <!-- 单位管理-部门管理 -->
    <div class="informationcx f14">
     <div class="title f16">
      <div class="titletext">公告详情</div>
     </div>
     <form action="/Team3_ZXJY/jspb/announceList.jsp" method="post" >
     <div class="mt">
       <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
        <tr>
          <td width="142" align="right" valign="middle">公告标题</td>
          <td width="1210"><input class="text01" type="text" name="annTitle" id="textfield" value="${an.annTitle}" readonly="readonly"/>&nbsp;&nbsp;<span class="red"></span></td>
        </tr>
         <tr>
          <td width="142" align="right" valign="middle">发布人</td>
          <td><input class="text01" type="text" name="annPeople" id="textfield" value="${an.annPeople}" readonly="readonly"/>&nbsp;&nbsp;<span class="red"></span></td>
        </tr>
         <tr>
          <td width="142" align="right" valign="middle">发布时间</td>
          <td><input class="text02" type="text" name="annTime" id="textfield" value="${an.annTime}" readonly="readonly"/>&nbsp;&nbsp;<span class="red"></span></td>
        </tr>
        <tr>
          <td align="right" valign="top">内容</td>
          <td>
          	<textarea class="textarea" name="annContent" id="textarea" cols="45" rows="5" placeholder="" readonly="readonly">${an.annContent}</textarea>	
      ...
      <div class="button_box">
	        <input class="submit" type="submit" name="button" id="button" value="返回" />
      </div>
   </div>
   </form>
    </div>
