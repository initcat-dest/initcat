...
<body>
	...
	<div class="wrapper margin clear" style="margin-top:20px;">
		...
		<div class="right conright">
			...
			<form action="changestupwd">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					class="table">
					<tr>
						<td width="115" align="right" valign="middle">请输入密码</td>
						<td><input onblur="checkoldPass(${student.stupassword})" id='upass' class="text01"
...
<tr>
								...
								<td><input name="stuId" type="hidden" class="text01"
									id="stuId" value="${student.stuId}" /></td>
							</tr>
