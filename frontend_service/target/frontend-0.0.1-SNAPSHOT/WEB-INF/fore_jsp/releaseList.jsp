 ...
 <div class="search">
      ...
      <table border="0" cellpadding="0" cellspacing="0" >
        <tr>
          ...
          <td width="80" align="right"><input class="button" type="button" name="button" id="button" onclick="doSub()" value="查&nbsp;询" /></td>
        </tr>
      </table>
    </div>
	...
	function checkAll(checkbox) {
     ...
     <div class="applybutton mt clear">
      <a href="/Team3_ZXJY/jspf/ReleaseNaire.jsp">添 加</a>
    <!--    <a href="javascript:updateSea()">修 改</a>-->
        <a href="javascript:deleteRel()">删 除</a>
     </div>
